...
Lazy.use {
  ...
  keys = {
    ...
    { "<leader>cm", mode = { "n", "v" }, "<cmd>CopilotChatModels<cr>", silent = true, desc = "Copilot Chat Models" },
    { "<leader>cp", mode = { "n", "v" }, "<cmd>CopilotChatPrompts<cr>", silent = true, desc = "Copilot Chat Prompts" },
    {
