...
function Dark.lualine()
  ...
  line.command = colorize(colors.peach)
    ...
    return {
      ...
      tabline = {
        lualine_a = {{
          ...
          filetype_names = { fzf = "FZF", lazy = "Lazy", NvimTree = "nvim-tree", checkhealth = "check-health" },
        }},
        lualine_z = { "tabs" }
      },
...
Lazy.use {
  ...
  opts = {
    ...
    keymap = {
      ...
      ["<Tab>"] = { function(cmp) return cmp.snippet_active() and cmp.accept() or cmp.select_next() end, "snippet_forward", "fallback" },
      ["<S-Tab>"] = { function(cmp) return cmp.snippet_active() and cmp.accept() or cmp.select_prev() end, "snippet_forward", "fallback" },
    },
  },
