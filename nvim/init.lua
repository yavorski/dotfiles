...
Lazy.use {
  ...
  config = function(_, options)
    ...
    for kind, _ in pairs(noice_icons.kinds) do
      local mini_icon, mini_highlight = mini_icons.get("lsp", kind:lower())
  ...
  opts = {
    ...
    sources = {
      ...
      providers = {
        ...
        path = { max_items = 10, score_offset = 75 },
        buffer = { max_items = 10, score_offset = 50 },
        snippets = { max_items = 10, score_offset = 25 }
      }
    },
