...
local Dark = {
  ...
  colors = {
    ...
    mantle    = "#181825", -- [!] Dark 12
    coal      = "#161622", -- [*] Dark 11
    slate     = "#14141f", -- [!] Dark 10
    crust     = "#11111b", -- [!] Dark 9
    dusk      = "#0f0f17", -- [*] Dark 8
    night     = "#0d1011", -- [*] Dark 7
    base      = "#0a0a0f", -- [!] Dark 6 -- Default BG
    dark      = "#0a0a0f", -- [*] Dark 6 -- Default BG
    darky     = "#07070c", -- [*] Dark 5
...
function Dark.editor()
  ...
  return {
    ...
    NormalFloat = { bg = colors.dark }, -- Floating windows
    FloatBorder = { fg = colors.blue, bg = colors.dark }, -- Border for floating windows
    ...
    MiniMapNormal = { fg = colors.dusk, bg = colors.dusk },
    ...
    NvimTreeCursorLine = { bg = colors.cosmic },
    ...
    BlinkCmpMenuBorder = { fg = colors.sky, bg = colors.dark },
...
function Dark.lualine()
  ...
  local function colorize(c, text)
    return {
      ...
      c = { bg = colors.darky, fg = text or c },
      x = { bg = colors.darky, fg = colors.text },
      y = { bg = colors.darky, fg = c }
    }
  end
  ...
  line.inactive = {
    a = { bg = colors.darky, fg = colors.skyblue, gui = "bold" },
    b = { bg = colors.darky, fg = colors.surface1, gui = "bold" },
    c = { bg = colors.darky, fg = colors.overlay0, gui = "bold" },
  }
  ...
  opts = {
    ...
    views = {
      ...
      cmdline_popup = {
        ...
        size = { min_width = 80, max_width = 120 },
