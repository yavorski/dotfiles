...
function Dark.editor(colors)
  ...
  return {
    ...
    MiniNotifyBorder = { fg = colors.mantle, bg = colors.mantle },
...
Lazy.use {
  ...
  opts = {
    ...
    fzf_opts = {
      ["--cycle"] = "",
      ["--scrollbar"] = "█",
      ["--color"] = "preview-scrollbar:#f5a97f",
  ...
  keys = {
    ...
    { "<leader>tm", "<cmd>FzfLua manpages<cr>", silent = true, desc = "FZF Man Pages" },
    { "<leader>th", "<cmd>FzfLua helptags<cr>", silent = true, desc = "FZF Help Tags" },
