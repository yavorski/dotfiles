...
Lazy.use {
  ...
  ft = { "cs", "razor" },
  config = function()
    -- Ensure roslyn/razor are in PATH
    local sep = system.is_windows and ";" or ":"
    vim.env.PATH = (vim.env.PATH or "") .. sep .. vim.fs.joinpath(rdkdir, "roslyn") .. sep .. vim.fs.joinpath(rdkdir, "razor")
