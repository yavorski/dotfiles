...
* [ArchWiki - UEFI - Secure Boot](https://wiki.archlinux.org/title/Unified_Extensible_Firmware_Interface/Secure_Boot#Assisted_process_with_sbctl)
* [ArchWiki - UKI - Unified Kernel Image](https://wiki.archlinux.org/title/Unified_kernel_image)
* [ArchWiki - TPM - PCR - Platform Configuration Registers](https://wiki.archlinux.org/title/Trusted_Platform_Module#Accessing_PCR_registers)
* [ArchWiki - Encrypt Entire System](https://wiki.archlinux.org/title/Dm-crypt/Encrypting_an_entire_system#LUKS_on_a_partition_with_TPM2_and_Secure_Boot)
